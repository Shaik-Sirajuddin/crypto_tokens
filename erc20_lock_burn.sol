...
contract Reboot is ERC20Base, ReentrancyGuard {
    uint256 public initialSupply = 1000000000 * (10 ** uint256(decimals())); //initial amount of tokens to be minted

    constructor() payable ERC20Base("Reboot", "RBT") {
