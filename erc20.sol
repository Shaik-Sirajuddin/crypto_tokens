...
contract acatch1 is ERC20Base, ReentrancyGuard {
    uint256 public maxSupply = 1000000000000 * (10 ** uint256(decimals())); //maximum amount of tokens that can be minted

    constructor() payable ERC20Base("acatch1", "ACAT1 ") {
