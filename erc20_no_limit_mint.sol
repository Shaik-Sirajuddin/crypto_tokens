...
contract EveryDay is ERC20Base, ReentrancyGuard {

    constructor() payable ERC20Base("EveryDay", "EDAY ") {
        mint(msg.sender, 200000 * (10 ** uint256(decimals())));
    }

    /** Issuing Additional Tokens
    @dev mint tokens to owner account
    ...
    //A function to withdraw base currency from the contract
